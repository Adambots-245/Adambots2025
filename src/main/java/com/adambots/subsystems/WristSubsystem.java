...
public class WristSubsystem extends SubsystemBase {
  ...
  public enum WristState {
    ...
    HighAlgaeAuton(new WristProperties(ElevatorConstants.kWristHighAlgaePosition-5, "High Algae Angle for auton")),
    LowAlgae(new WristProperties(ElevatorConstants.kWristLowAlgaePosition, "Low Algae Angle")),
    LowAlgaeAuton(new WristProperties(ElevatorConstants.kWristLowAlgaePosition-5, "Low Algae Angle for auton")),
