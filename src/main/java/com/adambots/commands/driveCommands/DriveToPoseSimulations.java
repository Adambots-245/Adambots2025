        ...
        if (isSeen == true && isCalculated == false) {
            ...
            switch (idSeen) {
                ...
                case 17:
                    ...
                    break;
                case 18:
                    targetPose = new Pose2d(new Translation2d(3.169, 4.035), new Rotation2d(Math.toRadians(0)));
                    reefAngle = 90;
                    isInveresed = false;
                    break;
                case 19:
                    targetPose = new Pose2d(new Translation2d(3.832, 5.166), new Rotation2d(Math.toRadians(-60)));
                    reefAngle = 30;
                    isInveresed = false;
                    break;
                case 20:
                    ...
                    break;
                case 21:
                    targetPose = new Pose2d(new Translation2d(5.811, 4.025), new Rotation2d(Math.toRadians(-180)));
                    reefAngle = 90;
                    isInveresed = false;
                    break;
                case 22:
                    targetPose = new Pose2d(new Translation2d(5.138, 2.884), new Rotation2d(Math.toRadians(120)));
                    reefAngle = 30;
                    isInveresed = false;
                    break;
            }
